...
add_action('wp_ajax_get_bookfair_info_after_today', 'get_bookfair_info_after_today');
add_action('wp_ajax_nopriv_get_bookfair_info_after_today', 'get_bookfair_info_after_today');
