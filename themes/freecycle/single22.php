		...
		<div class="padder">
			...
			<?php do_action( 'bp_before_blog_single_post' ); ?>
					...
					<div class="post-content" id="post-content-edit">
						...
						<div class="booknam">商品名:
							 <?php echo get_the_title(); ?>
						</div>
						
						<div　class="authornam">著者名：
							<?php echo get_post_meta($post->ID, "author", true)?get_post_meta($post->ID, "author", true):"データがありません"; ?>
						</div>
                	...
                	$i++;
						...
						<div class="under">
							<div class="sub">カテゴリ <?php echo $main_category->cat_name;?> 、 <?php echo $sub_category[0]->cat_name; ?></div>
 							
							<div class="sub"><span class=first>必要ポイント数</span> <span class=second><?php echo get_post_meta($post->ID, "author", true)?get_post_meta($post->ID, "author", true):"データがありません"; ?></span></div>
							<div class="sub"><span class=first>Amazon価格</span> <span class=second><?php echo get_post_meta($post->ID, "price", true)?number_format(get_post_meta($post->ID, "price", true))."円":"データがありません"; ?></span></div>
							<div class="sub"><span class=first>在庫数</span> <span class=second><?php echo count_books($post->ID)?count_books($post->ID):0; ?>冊</span></div>
						</div>
						<div class="reserve">
