...
function biz_vektor_theme_options_render_page() { ?>
	<div class="wrap" id="biz_vektor_options">
		...
		<div id="sub-content">
		<iframe frameborder="0" height="1600" marginheight="0" marginwidth="0" scrolling="auto" src="http://bizvektor.com/info-admin/"></iframe>
		</div>
		<?php } ?>
...
<tr>
	...
	<td><a href="#postSetting">「<?php echo esc_html( bizVektorOptions('infoLabelName')); ?>」と「<?php echo esc_html( bizVektorOptions('postLabelName')); ?>」の設定</a>より設定下さい。</td>
</tr>
<tr>
...
<td>
<p>「<?php echo esc_html(bizVektorOptions('infoLabelName')); ?>」や「<?php echo esc_html(bizVektorOptions('postLabelName')); ?>」のリストの下の部分に表示されます。<br />
